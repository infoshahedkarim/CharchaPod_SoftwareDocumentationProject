	  ...
	  <h3> </h3>
	    ...
	    <form action="feedback.php" method="post" class="agile_form">
		  <h2>select the amount to pay</h2>
			...
			<h2></h2>
			<textarea placeholder="COURSE NAME" class="w3l_summary" name="comments" maxlength="3" required=""></textarea>
...
<br>
<p>
 <a href="../courses.php"><b><h1><center><h1 class="agile_head text-center">BACK</h1> </b></h1></center></a> </p></br></br>
	  </form>
	</div>
