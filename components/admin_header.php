...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">Chorcha Pod</a>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="../class.php"><i class="fas fa-address-card"></i><span>Online Class</span></a>
      ...
      <a href="contents_pdf.php"><i class="fas fa-book"></i><span>Materials</span></a>
      <a href=".php"><i class="fas fa-award"></i><span>Certificate</span></a>
