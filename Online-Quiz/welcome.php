...
<head>
    ...
    <title>Welcome | Online Assessment</title>
...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Online Assessment</b></a>
        </div>
        ...
        <li <?php echo''; ?> > <a href="logout.php?q=../Home.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Log out</a></li>
        </ul>
